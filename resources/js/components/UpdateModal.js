                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="modalNombre"></h5>
                        ...
                        <div className="modal-footer">
                            <button type="button" id='btnUpdate' idusuario='' onClick={this.props.handleUpdate} className="btn btn-primary">UPDATE</button>
